...
public class EliminationNarutoNormal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(EliminationNarutoNormal.this, "You must fill that field!", Toast.LENGTH_SHORT).show();
                }
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(EliminationNarutoNormal.this);
