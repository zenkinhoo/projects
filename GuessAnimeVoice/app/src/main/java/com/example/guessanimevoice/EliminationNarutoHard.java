...
public class EliminationNarutoHard extends AppCompatActivity {
    ...
    boolean wrong = false; //kada pogresno odgovori , ispada iz igre
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtUptext = (TextView) findViewById(R.id.txtUptext);
        ...
        final MediaPlayer bakaSound = MediaPlayer.create(this,R.raw.bee1); //zvuk kad si izgubio
            ...
            public void onClick(View v) {
                ...
                if(!enterSolution.getText().toString().equals("")) {
                    ...
                    if (enterSolution.getText().toString().equals(solutions.get(index))) {
                        ...
                        score++;
                        soundCorrect.start();
                        if(curr==39) //znaci da je igrica pobedjena
                        {
                            ...
                            scoreDialog.getWindow().setLayout((8*width)/9,(2*height)/7);
                            finishScore.setText(String.format("You have answered all 41 sounds correctly!Congratulations , you are on the KAGE lever",score));
                     ...
                     //   soundWrong.start();
                  //      txtUptext.setText("You lost BAKA!Click finish button to go to main menu.");
                     //   btnNext.setText("Finish");
                        wrong = true;
                ...
                {
                    Toast.makeText(EliminationNarutoHard.this, "You must fill that field!", Toast.LENGTH_SHORT).show();
                }
                if(wrong) //kada dodje do kraja pitanja
                {
                    soundCorrect.release();
                    soundWrong.release();

                    bakaSound.start();
                    bakaSound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        @Override
                        public void onCompletion(MediaPlayer mp) {
                            bakaSound.release();
                        }
                    ...
                    finishScore.setText(String.format("You lost BAKA! Your score is %d",score));
                    backToMain.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            finish();
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(EliminationNarutoHard.this);
